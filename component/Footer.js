...
import { LOGO_LINK } from '../src/utils';
    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img class="w-auto h-9" src={LOGO_LINK} alt="Logo-link" />

                <p class="text-base leading-relaxed text-gray-600 mt-7">Elevate your trading experience with our easy-to-use automation platform. We are simplifying strategy automation for novices and seasoned traders with our multiple broking facilities. A one-stop solution for executing, monitoring, and exiting from your trades.</p>
            ...
            <div>
                ...
                <ul class="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Live-Trade Calls </a>
                    </li>
